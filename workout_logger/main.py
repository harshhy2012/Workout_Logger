...
def new_workout_post():
    ...
    crunches = request.form.get('crunches')
    comment = request.form.get('comment')

    workout = Workout(pushups=pushups, squats=squats, crunches=crunches,comment=comment, author=current_user)
...
def update_workout(workout_id):
    ...
    if request.method == 'POST':
        ...
        workout.squats = request.form['squats']
        workout.crunches = request.form['crunches']
